...
class RandomImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (random == 5) {
      return SizerUtil.orientation == Orientation.portrait
          ? Lottie.asset('assets/home/l1.json', animate: true, repeat: true)
          : Align(
              alignment: Alignment.center,
              child: Lottie.asset(
                'assets/home/l1.json',
                  ...
                  child: ListView(
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText: "Type someone's first name..",
                              hintStyle:
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            var req = await http.get(Uri.parse(
                                'https://api.nationalize.io/?name=${controller.text}'));
                      ...
                      GestureDetector(
                        onTap: () async {
                          await launch(
                              'https://rishiahuja.github.io/my-portfolio');
                        },
                        child: Align(
                          alignment: Alignment.center,
                          child: Row(
